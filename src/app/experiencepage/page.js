...
const experiences = [
  {
    ...
    description: (
      <ul className="list-disc pl-4">
        <li>Developed Python-based ETL scripts to profile and transform MS SQL Server data...</li>
        <li>Conducted User Acceptance Testing (UAT) for multiple government programs...</li>
        <li>Automated data ingestion into Azure SQL Database via ADF pipelines...</li>
        <li>Designed data models and wrote Spark SQL in Azure Databricks...</li>
      </ul>
    ),
  },
  {
    ...
    description: (
      <ul className="list-disc pl-4">
        <li>Implemented MVVM architecture for scalable and maintainable CIBC pilot feature.</li>
        <li>Integrated Adobe Analytics to track user engagement.</li>
  ...
  },
  {
    ...
    description: (
      <ul className="list-disc pl-4">
        <li>Replaced legacy SSIS data pipelines with python-based ETL processes.</li>
        <li>Worked with PostgreSQL and MongoDB for data extraction.</li>
        <li>Experienced in creating Snowpipes in Snowflake for continuous ingestion.</li>
        <li>Developed Python scripts to automate the weekly download of hundreds of documents.</li>
      </ul>
    ),
  },
];
          ...
          <div className="flex flex-col flex-1 ml-8">
            {experiences.map((exp, idx) => (
              <div key={idx} className="mb-8 flex items-center" style={{ minHeight: `${dotSpacing}px` }}>
                <div className="w-full p-6 bg-white/90 text-black shadow-xl dark:bg-zinc-900/90 dark:text-white flex flex-col justify-center rounded-lg border border-gray-200 dark:border-zinc-800 backdrop-blur-md hover:border-purple-500 transition-all duration-300">
